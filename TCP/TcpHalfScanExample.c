//                "-g","-o", 
//                "./TCP/TcpHalfOpenScan", "./TCP/tcplib.c", "./TCP/TcpHalfScanExample.c", "-lpcap", "-lpthread"
// @autor       Wonseok. J
// @info        Only ubuntu. this program half scan specific ip.
//              This program doesn't use libq libary.
...
int main(void){
    ...
    make_tcp_header(&(tcp_packet), sip, htons(0x1111), dip, htons(0x2222), htonl(0x11223344), htonl(0x55667788), 0);
